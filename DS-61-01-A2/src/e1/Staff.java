...
public class Staff extends Members{
    public enum Category {
        Caretaker {     public int calculate(int n) { return (n * 65); }
                        public int salary() { return 150; } },
        Gamekeeper {    public int calculate(int n) { return (n * 75); }
    ...
    int getReward() { return (getCategory().calculate(getHorcruxes())); }
